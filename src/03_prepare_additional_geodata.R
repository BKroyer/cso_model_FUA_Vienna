...
imp_input <- rast("C:/Users/simulation/bkroyer/git_clone/cso-modell-upper-danube/data/imp2021_AoI_incl_AUT.tif")
...
saveRDS(imp[,.(settlement_id, imp_area_km2)], file.path(path_input, "impervious_area_2021_AUT.rds"))
